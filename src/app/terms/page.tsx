      ...
      <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <article className="prose prose-invert prose-cyan max-w-none space-y-6 text-sm md:text-base leading-relaxed">
          ...
          <section>
            ...
            <p>
              All branding, architecture, the "Taka AI" name, and gateway interface designs are the intellectual property of Takadori. The content generated by the AI models remains subject to the licenses of the respective underlying foundation models (e.g., Llama, Qwen, Mistral).
            </p>
          </section>
        </article>
      </div>
